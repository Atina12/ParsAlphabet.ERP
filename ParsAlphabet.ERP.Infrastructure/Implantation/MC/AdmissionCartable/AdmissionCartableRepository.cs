...
namespace ParsAlphabet.ERP.Infrastructure.Implantation.MC.AdmissionCartable;

public class AdmissionCartableRepository :
    BaseRepository<AdmissionCartableGetPage, long, string>,
    IBaseRepository<AdmissionCartableGetPage, long, string>
{
    ...
    public AdmissionCartableRepository(
    ...
    public GetColumnsViewModel GetColumnsCartable()
    {
        var list = new GetColumnsViewModel
        {
            ...
            DataColumns = new List<DataColumnsViewModel>
            {
                ...
                new()
                {
                    Id = "departmentName", Title = "دپارتمان", Type = (int)SqlDbType.SmallInt, IsDtParameter = true,
                    IsFilterParameter = true, Width = 10
                },
                new()
                {
                    Id = "reserveDatePersian", Title = "تاریخ رزرو نوبت", IsPrimary = true,
                    Type = (int)SqlDbType.NVarChar, Size = 10, IsDtParameter = true, Width = 6
                },
                new()
                {
                    Id = "admissionReserveNo", Title = "نوبت", Type = (int)SqlDbType.Int, IsDtParameter = true,
                    Width = 4
                },
                new()
                {
                    Id = "attender", Title = "طبیب", Type = (int)SqlDbType.NVarChar, IsDtParameter = true, Width = 7
                },
                new()
                {
                ...
                new()
                {
                    Id = "basicInsurerNo", Title = "شماره بیمه", Type = (int)SqlDbType.NVarChar, Size = 20,
                    IsDtParameter = true, Width = 6
                },
                new()
                {
                    Id = "lineCount", Title = "تعداد خدمت", Type = (int)SqlDbType.NVarChar, Size = 20,
        ...
        list.Buttons = new List<GetActionColumnViewModel>
        {
            ...
            new()
            {
                Name = "inboundservicelist", Title = "نمایش پذیرش", ClassName = "btn blue_outline_1",
                IconName = "fa fa-list"
            },
            new() { Name = "inboundprint", Title = "چاپ", ClassName = "btn blue_outline_2", IconName = "fa fa-print" }
        };
    ...
    {
        var fromWorkDayDate = model.Form_KeyValue[6]?.ToString().ToMiladiDateTime();
        var toWorkDayDate = model.Form_KeyValue[7]?.ToString().ToMiladiDateTime();

        var parameters = new DynamicParameters();

        parameters.Add("StageId", model.Form_KeyValue[0]?.ToString() != null ? model.Form_KeyValue[0]?.ToString() : null);
        parameters.Add("WorkflowId",
            model.Form_KeyValue[1]?.ToString() != null ? model.Form_KeyValue[1]?.ToString() : null);
        parameters.Add("AttenderId", model.Form_KeyValue[2] != null ? model.Form_KeyValue[2] : null);
        parameters.Add("PatientId",
            model.Form_KeyValue[3]?.ToString() != null ? model.Form_KeyValue[3]?.ToString() : null);
        parameters.Add("Id", model.Form_KeyValue[4]?.ToString() != null ? model.Form_KeyValue[4]?.ToString() : null);
        ...
        parameters.Add("BranchId",
            model.Form_KeyValue[9]?.ToString() != null ? model.Form_KeyValue[9]?.ToString() : null);
        parameters.Add("AdmissionMasterId",
            model.Form_KeyValue[10]?.ToString() != null ? model.Form_KeyValue[10]?.ToString() : null);
        ...
        {
            var sQuery = "[mc].[Spc_AdmissionService_Cartable_Section]";
            conn.Open();
            var result =
    ...
    public async Task<MyResultPage<List<AdmissionCartableGetPage>>> GetCartable(NewGetPageViewModel model, byte roleId)
    {
        var result = new MyResultPage<List<AdmissionCartableGetPage>>
        {
            Data = new List<AdmissionCartableGetPage>()
        };
        ...
        using (var conn = Connection)
        {
            var sQuery = "[mc].[Spc_AdmissionService_Cartable]";
            conn.Open();
            result.Data =
                (await conn.QueryAsync<AdmissionCartableGetPage>(sQuery, parameters,
    ...
    public async Task<List<WorkListHeader>> GetWorkListHeader(GetSectionCartable model)
    {
        var parameters = new DynamicParameters();
        ...
        using (var conn = Connection)
        {
            var sQuery = "mc.Spc_AdmissionAction_WorkList_Header";
            conn.Open();
            var result =
                (await conn.QueryAsync<WorkListHeader>(sQuery, parameters, commandType: CommandType.StoredProcedure))
                .ToList();
            conn.Close();
    ...
    public async Task<List<WorkListLine>> GetWorkListLine(GetSectionCartable model)
    {
        var parameters = new DynamicParameters();
        ...
        using (var conn = Connection)
        {
            var sQuery = "[mc].Spc_AdmissionAction_WorkList_Line";
            conn.Open();
            var result =
                (await conn.QueryAsync<WorkListLine>(sQuery, parameters, commandType: CommandType.StoredProcedure))
                .ToList();
            conn.Close();
    ...
    public async Task<int> GetWorkListCount(GetSectionCartable model, byte roleId)
    {
        var parameters = new DynamicParameters();
        ...
        using (var conn = Connection)
        {
            var sQuery = "[mc].Spc_AdmissionAction_WorkList_Count";
            conn.Open();
    ...
    public async Task<List<AdmissionWorkflowStageAction>> GetAdmissionWorkflowStageAction(
        GetAdmissionWorkflowStageAction model)
    {
        var parameters = new DynamicParameters();
      
            var workflowId = Convert.ToInt32(model.WorkflowId.ToString());
            var stageId = Convert.ToInt32(model.StageId.ToString());
            ...
            using (var conn = Connection)
            {
                var sQuery = "[mc].[Spc_AdmissionWorkflow_Get]";
                conn.Open();

                var result =
                    await conn.QueryAsync<AdmissionWorkflowStageAction>(sQuery, parameters,
                        commandType: CommandType.StoredProcedure);
    ...
    public async Task<object> GetAdmissionWorkflowStageActionDetail(GetAdmissionWorkflowStageAction model)
    {
        var parameters = new DynamicParameters();
        ...
        using (var conn = Connection)
        {
            var sQuery = "[mc].[Spc_AdmissionWorkflowDetail_Get]";
            conn.Open();
