...
public class NewTreasuryLineModel
{
    ...
    public int LastAccountGLId { get; set; }
    public int LastAccountSGLId { get; set; }
    public int LastAccountDetailId { get; set; }
    public int WorkflowId { get; set; }
    public int ParentWorkFlowCategoryId { get; set; }
    public short NoSeriesId { get; set; }

    public List<PostingGroupbyTypeLineModel> TreasuryPostingList { get; set; }
}

public class PreviousStageTreasuryLineModel
{
    public int Id { get; set; }
    public short StageId { get; set; }
    public int HeaderId { get; set; }
