...
public class PurchaseOrderLineModel
{
    ...
    public List<PersonInvoicePostingGroupModel> PersonInvoicePostingGroup { get; set; }
...
public class PersonInvoicePostingGroupModel
{
...
public class PurchaseOrderLineDetailModel
{
...
public class PurchaseOrderLineDelete
{
    public int Id { get; set; }
    public int HeaderId { get; set; }
    public short StageId { get; set; }
