...
public class BranchService : IBranchService
{
    ...
    public BranchService(IHttpClientFactory clientFactory)
    {
        _clientFactory = clientFactory;
    }

    public async Task<HttpResult<ResultQuery>> SendBranch(CentralBranch model, string token)
    {
        ...
        var url = CallWebService.CentralApiUrl.ErpNode.Branch.SendBranchUrl;
