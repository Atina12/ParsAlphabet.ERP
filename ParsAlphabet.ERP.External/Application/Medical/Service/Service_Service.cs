...
public class Service_Service : IService_Service
{
    ...
    public Service_Service(IHttpClientFactory clientFactory)
    {
        _clientFactory = clientFactory;
    }

    public async Task<HttpResult<ResultQuery>> SendService(CentralService model, string token)
    {
        ...
        var url = CallWebService.CentralApiUrl.ErpNode.Service.SendServiceUrl;
