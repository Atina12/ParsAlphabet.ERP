var viewData_form_title = "تنظیمات مراحل انبار",
    ...
    viewData_print_file_url = `${stimulsBaseUrl.WH.Prn}WarehouseStageAction.mrt`, 
...
function callbackAfterFilter() {
    ...
    $(".dropdown-menu #filter_actionId").data("api", `${viewData_baseUrl_WF}/StageActionApi/getdropdownactionlistbystage/null/11/1/0/null/${workflowCategoryIds.purchase.id}/false/null`);
}
...
$("#stimul_preview").click(function () {
    ...
    var check = controller_check_authorize("WarehouseStageActionApi", "PRN");
    if (!check)
        return;
