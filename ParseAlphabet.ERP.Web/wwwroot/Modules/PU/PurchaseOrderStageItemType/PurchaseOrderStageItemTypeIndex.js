var viewData_form_title = "مراحل / نوع آیتم",
    ...
    viewData_controllername = "PurchaseOrderStageItemTypeApi",
    ...
    viewData_print_file_url = `${stimulsBaseUrl.PU.Prn}PurchaseOrderStageItemType.mrt`,
    viewData_print_model = { url: viewData_print_file_url, item: "@Id", value: 0, sqlDbType: 8, size: 0 },
    viewData_print_tableName = "",
    isSecondLang = false;

//fill_select2(`${viewData_baseUrl_PU}/NewTreasuryApi/treasurystage`, "stageId", true);
//fill_select2(`${viewData_baseUrl_PU}/NewTreasuryApi/treasurystage`, "previousStageId", true);
//fill_select2(`${viewData_baseUrl_PU}/TreasuryStageFundItemTypeApi/postinggrouptype`, "postingGroupTypeId", true);
//fill_select2(`/api/FMApi/fundtype_getdropdown`, "fundTypeId", true);
...
function callbackAfterFilter() {
    ...
    $(".dropdown-menu #filter_fundItemTypeId").data("api", `${viewData_baseUrl_WF}/StageFundItemTypeApi/stagefunditemtype_getdropdown/null/1`);
}
...
$("#stimul_preview").click(function () {
    ...
    var reportParameters = [
        ...
        { Item: `WorkflowCategoryId`, Value: 1, SqlDbType: dbtype.Int, Size: p_size }
    ]
