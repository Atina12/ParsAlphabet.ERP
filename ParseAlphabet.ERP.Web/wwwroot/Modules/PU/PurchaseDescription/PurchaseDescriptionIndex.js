var viewData_form_title = "شرح سند خرید";


var viewData_controllername = "PurchaseDescriptionApi";
...
var viewData_print_file_url = `${stimulsBaseUrl.PU.Prn}PurchaseDescription.mrt`;
var viewData_print_model = { url: viewData_print_file_url, item: "@Id", value: 0, sqlDbType: 8, size: 0 }
var viewData_print_tableName = "";

fill_select2(`${viewData_baseUrl_WF}/StageApi/getdropdown`, "stageId", true, "1/0/2/1");
...
function callbackAfterFilter() {
    $(".dropdown-menu #filter_stage").data("api", `${viewData_baseUrl_WF}/StageApi/getdropdown/1/0/2/1`)
}
