var viewData_form_title = "مراحل خرید",

    viewData_controllername = "PurchaseOrderStageApi",
    ...
    viewData_print_file_url = `${stimulsBaseUrl.PU.Prn}PersonOrderStage.mrt`,
...
function callbackAfterFilter() {
    $(".dropdown-menu #filter_stageClass").data("api", `${viewData_baseUrl_WF}/StageApi/getStageClassDropDown/1`);
}
