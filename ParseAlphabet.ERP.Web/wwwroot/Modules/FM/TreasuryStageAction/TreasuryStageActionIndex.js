var viewData_form_title = "تنظیمات مراحل خزانه",
    ...
    viewData_print_file_url = `${stimulsBaseUrl.FM.Prn}TreasuryStageAction.mrt`,
...
function callbackAfterFilter() {
    $(".dropdown-menu #filter_stageId").data("api", `${viewData_baseUrl_WF}/StageApi/getdropdown/6/0/2/1`);
    $(".dropdown-menu #filter_actionId").data("api", `${viewData_baseUrl_WF}/StageActionApi/getdropdownactionlistbystage/null/6/1/0/null/${workflowCategoryIds.treasury.id}/false/null`);
...
$("#stimul_preview").click(function () {
    ...
    var check = controller_check_authorize("TreasuryStageActionApi", "PRN");
    if (!check)
        return;
    ...
    var reportParameters = [
        ...
        { Item: "WorkflowCategoryId", Value: 6, SqlDbType: dbtype.Int, Size: 0 },
        //{ Item: "WorkflowId", Value: null, SqlDbType: dbtype.Int, Size: 0 },
        { Item: `Id`, Value: null, SqlDbType: p_type, Size: p_size },
        { Item: `ActionId`, Value: null, SqlDbType: p_type, Size: p_size },
        { Item: `StageId`, Value: null, SqlDbType: p_type, Size: p_size },
    ]
