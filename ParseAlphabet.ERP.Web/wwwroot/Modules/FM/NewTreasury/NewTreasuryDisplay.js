...
var viewData_getpagetableDisplay_url = `${viewData_baseUrl_FM}/NewTreasuryLineApi/display`,
    viewData_getlinepagetable_url = `${viewData_baseUrl_FM}/NewTreasuryLineApi/gettreasurylinepage`,
    viewData_getTreasuryCheckExist = `${viewData_baseUrl_FM}/NewTreasuryApi/checkexist`,
    lastPageHeaderDisplayloaded = 0, activePageIdDisplay = "treasuryLineDisplayPage",
    display_PageRowsCount = 15;


function display_pagination_display(opr) {
    var elemId = +$("#treasuryLineDisplayPage #headerDisplay_pagetable #col_1_1").text();
...
async function display_paginationAsync_display(opr, elemId) {
    ...
    initDisplayTreasuryFrom(headerPagination, elemId)
}
...
function headerindexChoose_display(e) {
    ...
    if (e.keyCode === KeyCode.Enter) {
        ...
        if (checkExist) {
            initDisplayTreasuryFrom(0, +elm.val());
        }
        else
...
function initDisplayTreasuryFrom(headerPagination = 0, id = 0) {

    pagetable_formkeyvalue[0] = id == 0 ? $(`#${activePageIdDisplay} #treasuryId`).val() : id;
    ...
    pagetable_formkeyvalue[6] = $(`#${activePageIdDisplay} #requestId`).val();
    ...
    if (arr_pagetables.findIndex(a => a.pagetable_id == "lineDisplay_pagetable") < 0) {
        ...
        pagetable = {
            ...
            editable: false,
            pagerowscount: display_PageRowsCount,
            currentpage: 1,
            endData: false,
            pageNo: 0,
            lastpage: 1,
            ...
            headerType: "outline",
            selectedItems: [],
            getsum_url: `${viewData_baseUrl_FM}/NewTreasuryLineApi/treasurylinesum`,
        ...
        arr_pagetables[index2].pagerowscount =  display_PageRowsCount
        ...
        arr_pagetables[index2].getsum_url= `${viewData_baseUrl_FM}/NewTreasuryLineApi/treasurylinesum`
    ...
    get_DisplayPageTable("headerDisplay_pagetable", id => {
        ...
        get_DisplayNewPageTable("lineDisplay_pagetable",
            function () {
                modal_show("displayTreasuryLineModel");
            });
    });
}
...
function get_DisplayNewPageTable(pg_id = null, callBack = undefined, isInsert = false) {
    ...
    let url = "/api/FM/NewTreasuryLineApi/gettreasurylinepage";
...
function afterFillPage(pg_name) {
    ...
    //fillTreasuryDiaplayLineFooter(id);
...
function fillTreasuryDiaplayLineFooter(rowIdSelect) {

    getfillTreasuryDiaplayLineFooter(rowIdSelect).then(function (data) {
        
        $("#fillTreasurylineFooterTbody").html("");
        ...
        if (data.length > 0) {
            ...
            $("#fillTreasurylineFooterTbodyfieldset").removeClass("displaynone");
            let strTbodyTh = `
            ...
            $(strTbodyTh).appendTo("#fillTreasurylineFooterTbody");
        }

        else
            $("#fillTreasurylineFooterTbodyfieldset").addClass("displaynone");
    });
}

async function getfillTreasuryDiaplayLineFooter(id) {
