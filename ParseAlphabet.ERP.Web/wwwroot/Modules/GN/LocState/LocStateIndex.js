var viewData_form_title = "ولایت";


var viewData_controllername = "LocStateApi";
...
var viewData_print_file_url = `${stimulsBaseUrl.GN.Prn}LocState.mrt`;
var viewData_print_model = { url: viewData_print_file_url, item: "@Id", value: 0, sqlDbType: 8, size: 0 }
var viewData_print_tableName = "gn.LocState";
isSecondLang = true;
