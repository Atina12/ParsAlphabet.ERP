/*
 Template Name: CIS - Responsive Bootstrap 4 Admin Home
 Author: Themesdesign
 File: Home Init
 */
...
!function ($) {
  ...
  var Home = function () {
      ...
      //creates area chart
      Home.prototype.createAreaChart = function (element, pointSize, lineWidth, data, xkey, ykeys, labels, lineColors) {
          Morris.Area({
              element: element,
              pointSize: 0,
              lineWidth: 0,
      ...
      //creates Donut chart
      Home.prototype.createDonutChart = function (element, data, colors) {
          Morris.Donut({
              element: element,
              data: data,
              resize: true,
    ...
    Home.prototype.createLineChart1 = function(element, data, xkey, ykeys, labels, lineColors) {
      Morris.Line({
          element: element,
          data: data,
          xkey: xkey,
      ...
      Home.prototype.init = function () {
          ...
          var $donutData = [
              {label: "Download SMs", value: 12},
              {label: "In-Store SMs", value: 30},
              {label: "Mail-Order SMs", value: 20}
          ];
