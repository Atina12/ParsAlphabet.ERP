var viewData_form_title = "شرح فروش";


var viewData_controllername = "SaleDescriptionApi";
...
var viewData_print_file_url = `${stimulsBaseUrl.SM.Prn}SaleDescription.mrt`;
var viewData_print_model = { url: viewData_print_file_url, item: "@Id", value: 0, sqlDbType: 8, size: 0 }
var viewData_print_tableName = "";
fill_select2(`${viewData_baseUrl_WF}/StageApi/getdropdown/3/0/2/1`, "stageId", true);
...
$("#stimul_preview").click(function () {
    ...
    var reportParameters = [
        ...
        { Item: "WorkflowCategoryId", Value: 3, SqlDbType: dbtype.Int, Size: 0 },
...
function callbackAfterFilter() {
    $(".dropdown-menu #filter_stage").data("api", `${viewData_baseUrl_WF}/StageApi/getdropdown/3/0/2/1`)
}
