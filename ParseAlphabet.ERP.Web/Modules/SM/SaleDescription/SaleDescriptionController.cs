...
namespace ParseAlphabet.ERP.Web.Modules.SM.SaleDescription;

[Route("api/SM/[controller]")]
[ApiController]
[Authorize]
public class SaleDescriptionApiController(
...
[Route("SM")]
[Authorize]
public class SaleDescriptionController : Controller
{
    [Route("[controller]")]
    [HttpGet]
    public ActionResult Index()
    {
        return PartialView(Views.SM.SaleDescription);
    }
}