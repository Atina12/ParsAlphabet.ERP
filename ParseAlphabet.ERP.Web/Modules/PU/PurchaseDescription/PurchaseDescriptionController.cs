...
namespace ParseAlphabet.ERP.Web.Modules.PU.PurchaseDescription;

[Route("api/PU/[controller]")]
[ApiController]
[Authorize]
public class PurchaseDescriptionApiController(
...
[Route("PU")]
[Authorize]
public class PurchaseDescriptionController : Controller
{
    [Route("[controller]")]
    [HttpGet]
    [Authenticate(Operation.VIW, "")]
    ...
    {
        return PartialView(Views.PU.PurchaseDescription);
    }
}