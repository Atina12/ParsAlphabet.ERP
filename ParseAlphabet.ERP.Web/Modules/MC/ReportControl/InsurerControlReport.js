var viewData_controllername = "ReportControlApi",
    viewData_PreviewReport_GetReport = `${viewData_baseUrl_MC}/${viewData_controllername}/insurercontrolgetpage`,
    viewData_PreviewReport_GetHeader = `${viewData_baseUrl_MC}/${viewData_controllername}/insurercontrolcolumns`,
    viewData_form_title = "گزارش کنترلی بیمه",
    viewData_csv_url = `${viewData_baseUrl_MC}/${viewData_controllername}/insurercontrolcsv`,
    reportUrl = `${stimulsBaseUrl.MC.Rep}Insurer_Control.mrt`,
    form = $('.card-body').parsley();


function initInsurerControlerReport() {
...
$("#showReport").on("click", function () {
    ...
    var repParameters = [
        { Item: "insurerTypeId", Value: $(`#type`).val(), SqlDbType: dbtype.Int, Size: 10 },
    ]
