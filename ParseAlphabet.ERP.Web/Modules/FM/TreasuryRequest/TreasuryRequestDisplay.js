...
var viewData_getpagetableDisplayTreasuryRequest_url = `${viewData_baseUrl_FM}/TreasuryRequestLineApi/display`,
    viewData_getlinepagetableTreasuryRequest_url = `${viewData_baseUrl_FM}/TreasuryRequestLineApi/gettreasuryrequestlinepage`,
    lastPageHeaderDisplayloaded = 0, activePageIdDisplay = "treasuryRequestDisplayPage",
    display_PageRowsCount = 15;


function display_pagination_display(opr) {
    var elemId = +$("#treasuryRequestDisplayPage #headerDisplay_pagetable #col_1_1").text();
...
async function display_paginationAsync_display(opr, elemId) {
    ...
    initDisplayTreasuryRequestFrom(headerPagination, elemId)
}
...
function headerindexChoose_display(e) {
    ...
    if (e.keyCode === KeyCode.Enter) {
        ...
        if (checkExist) {
            initDisplayTreasuryRequestFrom(0, +elm.val());
        }
        else
...
function checkExistTreasuryRequestLineId(id) {
    ...
    var url = `${viewData_baseUrl_FM}/TreasuryRequestApi/checkexist`;
    let outPut = $.ajax({
        url: url,
        async: false,
        type: "post",
...
function initDisplayTreasuryRequestFrom(headerPagination = 0, id = 0) {
    ...
    if (arr_pagetables.findIndex(a => a.pagetable_id == "headerDisplay_pagetable") < 0) {
        pagetable = {
            ...
            headerType: "outline",
            selectedItems: [],
            getpagetable_url: viewData_getpagetableDisplayTreasuryRequest_url,
        };
        ...
        arr_pagetables[index1].getpagetable_url = viewData_getpagetableDisplayTreasuryRequest_url
    }
    ...
    if (arr_pagetables.findIndex(a => a.pagetable_id == "lineDisplay_pagetable") < 0) {
        ...
        pagetable = {
            ...
            headerType: "outline",
            selectedItems: [],
            getsum_url: `${viewData_baseUrl_FM}/TreasuryRequestLineApi/treasuryrequestlinesum`,
            getpagetable_url: viewData_getlinepagetableTreasuryRequest_url,
        };
        ...
        arr_pagetables[index2].getsum_url = `${viewData_baseUrl_FM}/TreasuryRequestLineApi/treasuryrequestlinesum`
        arr_pagetables[index2].getpagetable_url = viewData_getlinepagetableTreasuryRequest_url
    }
    ...
    get_DisplayPageTable("headerDisplay_pagetable", id => {
        ...
        get_DisplayNewPageTable("lineDisplay_pagetable",
            function () {
                modal_show("displayTreasuryRequestLineModel");
            });
    });
}
...
function get_DisplayNewPageTable(pg_id = null, callBack = undefined, isInsert = false) {
    ...
    let url = "/api/FM/TreasuryRequestLineApi/gettreasuryrequestlinepage";
    $.ajax({
        url: url,
        type: "POST",
...
initDisplayTreasuryRequestFrom();
