var viewData_form_title = "مراحل انبار",

    viewData_controllername = "WarehouseStageApi",
    ...
    viewData_print_file_url = `${stimulsBaseUrl.WH.Prn}WarehouseStage.mrt`,
...
function callbackAfterFilter() {
    $(".dropdown-menu #filter_stageClass").data("api", `${viewData_baseUrl_WF}/StageApi/getStageClassDropDown/11`);
}
