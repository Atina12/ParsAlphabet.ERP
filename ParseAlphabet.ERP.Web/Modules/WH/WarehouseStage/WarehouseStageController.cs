...
namespace ParseAlphabet.ERP.Web.Modules.WH.WarehouseStage;

[Route("api/WH/[controller]")]
[ApiController]
[Authorize]
public class WarehouseStageApiController(StageRepository stageRepository) : ControllerBase
{
    [HttpPost]
    [Route("getpage")]
...
[Route("WH")]
[Authorize]
public class WarehouseStageController : Controller
{
    [Route("[controller]")]
    [Authenticate(Operation.VIW, "")]
    [HttpGet]
    ...
    {
        return PartialView(Views.WH.WarehouseStage);
    }
}